...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [39] = {
    ...
    [anon_sym_if] = ACTIONS(153),
    [anon_sym_while] = ACTIONS(155),
    [sym_break] = ACTIONS(260),
    [sym_continue] = ACTIONS(260),
    [anon_sym_return] = ACTIONS(159),
    [anon_sym_DQUOTE] = ACTIONS(161),
    [sym_int] = ACTIONS(151),
    [sym_float] = ACTIONS(163),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign, 3, 0, 5),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assign, 3, 0, 5),
  [47] = {.entry = {.count = 1, .reusable = false}}, SHIFT(101),
  [49] = {.entry = {.count = 1, .reusable = false}}, SHIFT(92),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 2, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 2, 0, 0),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subscript, 3, 0, 6),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subscript, 3, 0, 6),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subscript, 4, 0, 6),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subscript, 4, 0, 6),
  ...
  [181] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(86),
  [184] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(70),
  [187] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(104),
  ...
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return, 2, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 2, 0, 0),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_return, 2, 0, 0), SHIFT(86),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_return, 2, 0, 0), SHIFT(70),
  [206] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_return, 2, 0, 0), SHIFT(104),
  [209] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_return, 2, 0, 0), SHIFT(107),
  [212] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_return, 2, 0, 0), SHIFT(74),
  [215] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_return, 2, 0, 0), SHIFT(101),
  [218] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [220] = {.entry = {.count = 1, .reusable = false}}, SHIFT(90),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0),
  [224] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [227] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  [230] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(94),
  [233] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [236] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(96),
  [239] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(160),
  [242] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  [248] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(153),
  [251] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(103),
  [254] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [257] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(102),
  [260] = {.entry = {.count = 1, .reusable = false}}, SHIFT(35),
  [262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [264] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [267] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  [270] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [273] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [276] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(97),
  [279] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(167),
  [282] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(68),
  [288] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(148),
  [291] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [294] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [297] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(100),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = false}}, SHIFT(38),
  [304] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(107),
  [307] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(74),
  [310] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym__statement, 1, 0, 0), SHIFT(101),
  ...
  [503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, 0, 8),
  ...
  [538] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 11), SHIFT_REPEAT(155),
  [541] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 11),
  ...
  [576] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4, 0, 10),
  ...
  [590] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, 0, 7),
  [592] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 7),
  ...
  [602] = {.entry = {.count = 1, .reusable = false}}, SHIFT(154),
  [604] = {.entry = {.count = 1, .reusable = false}}, SHIFT_EXTRA(),
  [606] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4, 0, 7),
  ...
  [614] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 5, 0, 10),
  [616] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, 0, 0),
};
